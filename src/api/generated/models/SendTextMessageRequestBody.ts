...
export class SendTextMessageRequestBody {
    'apnsBundleId'?: string;
    ...
    'isSilent'?: boolean;
    'markAsRead'?: boolean;
    'mentionType'?: SendTextMessageRequestBodyMentionTypeEnum;
    'mentionedUserIds'?: Array<string>;
    'message': string;
    /**
    * Specifies the type of the message. The value of MESG represents a text message.
    */
    'messageType': SendTextMessageRequestBodyMessageTypeEnum;
    'pollId'?: number;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "SendTextMessageRequestBodyMentionTypeEnum",
            "format": ""
        },
        {
        ...
        },
        {
            ...
            "type": "SendTextMessageRequestBodyMessageTypeEnum",
            "format": ""
        },
        {
            "name": "pollId",
    ...
    static getAttributeTypeMap() {
        return SendTextMessageRequestBody.attributeTypeMap;
    }
...
export type SendTextMessageRequestBodyMentionTypeEnum = "users" | "channel" ;
export type SendTextMessageRequestBodyMessageTypeEnum = "MESG" ;
