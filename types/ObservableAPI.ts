...
export class ObservableGroupChannelApi {
     ...
     */
    public createAGroupChannel(channelType: string, channelUrl: string, apiToken?: string, createAGroupChannelRequest?: CreateAGroupChannelRequest, _options?: Configuration): Observable<CreateAGroupChannelResponse> {
        const requestContextPromise = this.requestFactory.createAGroupChannel(channelType, channelUrl, apiToken, createAGroupChannelRequest, _options);
