...
export class ObservableBotApi {
     ...
     */
    public sendABotMessage(botUserid: string, apiToken?: string, sendABotMessageRequest?: SendABotMessageRequest, _options?: Configuration): Observable<SendABotMessageResponse> {
