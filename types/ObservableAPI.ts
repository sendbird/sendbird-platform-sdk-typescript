...
export class ObservableBotApi {
     ...
     * @param apiToken 
     */
    public leaveChannels(botUserid: string, channelUrl?: string, apiToken?: string, _options?: Configuration): Observable<any> {
        const requestContextPromise = this.requestFactory.leaveChannels(botUserid, channelUrl, apiToken, _options);
...
export class ObservableMessageApi {
     ...
     * @param body 
     */
    public migrateMessages(targetChannelUrl: string, apiToken?: string, body?: any, _options?: Configuration): Observable<any> {
        const requestContextPromise = this.requestFactory.migrateMessages(targetChannelUrl, apiToken, body, _options);
...
export class ObservableModerationApi {
     ...
     * @param freezeAGroupChannelRequest 
     */
    public freezeAnOpenChannel(channelUrl: string, apiToken?: string, freezeAGroupChannelRequest?: FreezeAGroupChannelRequest, _options?: Configuration): Observable<SendbirdOpenChannel> {
        const requestContextPromise = this.requestFactory.freezeAnOpenChannel(channelUrl, apiToken, freezeAGroupChannelRequest, _options);
     ...
     * @param apiToken 
     */
    public listBlockedUsers(userId: string, list?: string, token?: string, limit?: number, userIds?: string, metadatakey?: string, metadatavaluesIn?: string, apiToken?: string, _options?: Configuration): Observable<ListBlockedUsersResponse> {
...
export class ObservableOpenChannelApi {
     ...
     * @param apiToken 
     */
    public getAnOpenChannel(channelUrl: string, apiToken?: string, _options?: Configuration): Observable<SendbirdOpenChannel> {
        const requestContextPromise = this.requestFactory.getAnOpenChannel(channelUrl, apiToken, _options);
     ...
     * @param apiToken 
     */
    public listOpenChannels(token?: string, limit?: string, customTypes?: string, nameContains?: string, urlContains?: string, showFrozen?: string, showMetadata?: string, customType?: string, apiToken?: string, _options?: Configuration): Observable<ListOpenChannelsResponse> {
        const requestContextPromise = this.requestFactory.listOpenChannels(token, limit, customTypes, nameContains, urlContains, showFrozen, showMetadata, customType, apiToken, _options);
     ...
     * @param apiToken 
     */
    public unregisterOperators(channelUrl: string, operatorIds: string, deleteAll?: string, apiToken?: string, _options?: Configuration): Observable<any> {
...
export class ObservableUserApi {
     ...
     */
    public addARegistrationOrDeviceToken(userId: string, tokenType: string, apiToken?: string, addARegistrationOrDeviceTokenRequest?: AddARegistrationOrDeviceTokenRequest, _options?: Configuration): Observable<AddARegistrationOrDeviceTokenResponse> {
     ...
     * @param apiToken 
     */
    public removeARegistrationOrDeviceTokenFromAnOwner(tokenType: string, token: string, apiToken?: string, _options?: Configuration): Observable<Array<ViewWhoOwnsARegistrationOrDeviceTokenResponseInner>> {
     ...
     * @param apiToken 
     */
    public removeARegistrationOrDeviceTokenWhenUnregisteringASpecificToken(userId: string, tokenType: string, token: string, apiToken?: string, _options?: Configuration): Observable<RemoveARegistrationOrDeviceTokenWhenUnregisteringASpecificTokenResponse> {
        const requestContextPromise = this.requestFactory.removeARegistrationOrDeviceTokenWhenUnregisteringASpecificToken(userId, tokenType, token, apiToken, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.removeARegistrationOrDeviceTokenWhenUnregisteringASpecificToken(rsp)));
            }));
    }
     ...
     * @param apiToken 
     */
    public removeARegistrationOrDeviceTokenWhenUnregisteringAllDeviceTokens(userId: string, apiToken?: string, _options?: Configuration): Observable<RemoveARegistrationOrDeviceTokenWhenUnregisteringAllDeviceTokensResponse> {
        const requestContextPromise = this.requestFactory.removeARegistrationOrDeviceTokenWhenUnregisteringAllDeviceTokens(userId, apiToken, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.removeARegistrationOrDeviceTokenWhenUnregisteringAllDeviceTokens(rsp)));
            }));
    }
     ...
     * @param apiToken 
     */
    public viewWhoOwnsARegistrationOrDeviceToken(tokenType: string, token: string, apiToken?: string, _options?: Configuration): Observable<Array<ViewWhoOwnsARegistrationOrDeviceTokenResponseInner>> {
